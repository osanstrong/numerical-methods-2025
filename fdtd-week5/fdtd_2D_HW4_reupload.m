...
MY=100; %Max y
%Timestep count
MT=1500; %Max time, number of timesteps
...
Eeta=dt/dxy/ep0;     %updating variable   
Heta=dt/dxy/mu0;      %updating variable
...
for n=1:1:MT
    ...
    title(['\fontsize{20}Ez, time = ',num2str(round(n*dt*1e+15)),' timesteps (',num2str(n*dt),'s)']); 
